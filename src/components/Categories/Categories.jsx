...
const Categories = () => {
  return (
    ...
    <div className=' w-screen h-screen mx-auto px-3 py-4 grid grid-cols-4 gap-3'>
        ...
        <button className='absolute top-0 bottom-0 right-0 left-0 m-auto min-w-[100px] w-fit h-fit bg-white outline-none py-2 px-4 text-blue-900 font-semibold rounded-md'>Shoes</button>
        </Link>
        </div>
        <div className='w-full h-full overflow-hidden bg-women bg-cover relative bg-center'>
        <Link to="/products/3" className='min-w-[100px]'>
        <button className='absolute top-0 bottom-0 right-0 left-0 m-auto min-w-[100px] w-fit h-fit bg-white outline-none py-2 px-4 text-blue-900 font-semibold rounded-md'>Women</button>
        </Link>
        </div>
        ...
        <button className='absolute top-0 bottom-0 right-0 left-0 m-auto min-w-[100px] w-fit h-fit bg-white outline-none py-2 px-4 text-blue-900 font-semibold rounded-md'>Accesoriss</button>
        </Link>
        </div>
        <div className='w-full h-full relative overflow-hidden bg-sale bg-cover bg-center'>
        <Link to="/products/5" className='min-w-[100px]'>
        <button className='absolute top-0 bottom-0 right-0 left-0 m-auto min-w-[100px] w-fit h-fit bg-white outline-none py-2 px-4 text-blue-900 font-semibold rounded-md'>Sale</button>
        </Link>
        </div>
        ...
        <button className='absolute top-0 bottom-0 right-0 left-0 m-auto min-w-[100px] w-fit h-fit bg-white outline-none py-2 px-4 text-blue-900 font-semibold rounded-md'>New Season</button>
        </Link>
        </div>
    </div>
    </div>
